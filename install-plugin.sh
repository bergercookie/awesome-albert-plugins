...
announce "Cloning and installing taskwarrior -> $PLUGIN_DIR"
git clone "https://github.com/bergercookie/taskwarrior" "$PLUGIN_DIR"
announce "Installed taskwarrior -> $PLUGIN_DIR"
