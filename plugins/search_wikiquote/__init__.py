...
"""Wikiquote: Search suggestions for Wikiquote."""
...
__prettyname__ = "Wikiquote: Search suggestions for Wikiquote"
__version__ = "0.1.0"
__trigger__ = "quote "
...
icon_path = str(Path(__file__).parent / "search_wikiquote")
cache_path = Path(v0.cacheLocation()) / "search_wikiquote"
config_path = Path(v0.configLocation()) / "search_wikiquote"
data_path = Path(v0.dataLocation()) / "search_wikiquote"
        ...
        if not query.string:
            results.append(
                v0.Item(
                    id=__prettyname__,
                    icon=icon_path,
                    text=f'Search {"_".join("search_wikiquote".split("_")[1:])}',
