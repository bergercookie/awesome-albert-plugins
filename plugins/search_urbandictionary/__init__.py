...
"""Urbandictionary: Search suggestions for Urbandictionary."""
...
__prettyname__ = "Urbandictionary: Search suggestions for Urbandictionary"
__version__ = "0.1.0"
__trigger__ = "ud "
...
icon_path = str(Path(__file__).parent / "search_urbandictionary")
cache_path = Path(v0.cacheLocation()) / "search_urbandictionary"
config_path = Path(v0.configLocation()) / "search_urbandictionary"
data_path = Path(v0.dataLocation()) / "search_urbandictionary"
...
googler_at = "urbandictionary.com"
        ...
        if not query.string:
            results.append(
                v0.Item(
                    id=__prettyname__,
                    icon=icon_path,
                    text=f'Search {"_".join("search_urbandictionary".split("_")[1:])}',
