...
"""Hackaday: Search suggestions for Hackaday."""
...
__prettyname__ = "Hackaday: Search suggestions for Hackaday"
__version__ = "0.1.0"
__trigger__ = "had "
...
icon_path = str(Path(__file__).parent / "search_hackaday")
cache_path = Path(v0.cacheLocation()) / "search_hackaday"
config_path = Path(v0.configLocation()) / "search_hackaday"
data_path = Path(v0.dataLocation()) / "search_hackaday"
        ...
        if not query.string:
            results.append(
                v0.Item(
                    id=__prettyname__,
                    icon=icon_path,
                    text=f'Search {"_".join("search_hackaday".split("_")[1:])}',
