...
"""Sourceforge: Search suggestions for Sourceforge."""
...
__prettyname__ = "Sourceforge: Search suggestions for Sourceforge"
__version__ = "0.1.0"
__trigger__ = "sourceforge "
__author__ = "Nikos Koukis"
__dependencies__ = []
__homepage__ = "https://github.com/bergercookie/awesome-albert-plugins"

icon_path = str(Path(__file__).parent / "search_sourceforge")
cache_path = Path(v0.cacheLocation()) / "search_sourceforge"
config_path = Path(v0.configLocation()) / "search_sourceforge"
data_path = Path(v0.dataLocation()) / "search_sourceforge"
        ...
        if not query.string:
            results.append(
                v0.Item(
                    id=__prettyname__,
                    icon=icon_path,
                    text=f'Search {"_".join("search_sourceforge".split("_")[1:])}',
