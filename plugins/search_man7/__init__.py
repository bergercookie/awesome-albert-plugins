...
"""Man7: Search suggestions for Man7."""
...
__prettyname__ = "Man7: Search suggestions for Man7"
__version__ = "0.1.0"
__trigger__ = "man7 "
...
icon_path = str(Path(__file__).parent / "search_man7")
cache_path = Path(v0.cacheLocation()) / "search_man7"
config_path = Path(v0.configLocation()) / "search_man7"
data_path = Path(v0.dataLocation()) / "search_man7"
        ...
        if not query.string:
            results.append(
                v0.Item(
                    id=__prettyname__,
                    icon=icon_path,
                    text=f'Search {"_".join("search_man7".split("_")[1:])}',
