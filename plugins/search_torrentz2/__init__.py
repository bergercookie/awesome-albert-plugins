...
"""Torrentz2: Search suggestions for Torrentz2."""
...
__prettyname__ = "Torrentz2: Search suggestions for Torrentz2"
__version__ = "0.1.0"
__trigger__ = "to "
...
icon_path = str(Path(__file__).parent / "search_torrentz2")
cache_path = Path(v0.cacheLocation()) / "search_torrentz2"
config_path = Path(v0.configLocation()) / "search_torrentz2"
data_path = Path(v0.dataLocation()) / "search_torrentz2"
        ...
        if not query.string:
            results.append(
                v0.Item(
                    id=__prettyname__,
                    icon=icon_path,
                    text=f'Search {"_".join("search_torrentz2".split("_")[1:])}',
