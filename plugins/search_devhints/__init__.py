...
"""Devhints: Search suggestions for Devhints."""
...
__prettyname__ = "Devhints: Search suggestions for Devhints"
__version__ = "0.1.0"
__trigger__ = "dev "
...
icon_path = str(Path(__file__).parent / "search_devhints")
cache_path = Path(v0.cacheLocation()) / "search_devhints"
config_path = Path(v0.configLocation()) / "search_devhints"
data_path = Path(v0.dataLocation()) / "search_devhints"
        ...
        if not query.string:
            results.append(
                v0.Item(
                    id=__prettyname__,
                    icon=icon_path,
                    text=f'Search {"_".join("search_devhints".split("_")[1:])}',
